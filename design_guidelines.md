...
- Width: `w-64`
- Navigation items with icons (Lucide React icons)
...
- Contrast meeting WCAG AA standards

## Images
No hero images required. This is a dashboard/admin interface focused on data and forms. Use Lucide React icons throughout for navigation, actions, and visual hierarchy.